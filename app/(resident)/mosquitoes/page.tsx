...
const bedBugHeroData: HeroData = {
	...
	description:
		'Don’t let mosquitoes ruin your comfort or put your health at risk. At A Star Plus Pest Control, we deliver targeted, family-safe mosquito treatments that drastically reduce populations and keep them from coming back.',
	...
	items: [
		{
			...
			description:
				'Constant buzzing and swatting outdoors, especially in the evening when mosquitoes are most active.',
		},
		{
			icon: '/assets/residential/icons/mosquitoes/mosquito-mites.png',
			title: 'Mosquito Bites',
			description:
				'Itchy red bumps appearing frequently, often around arms, legs, and ankles after spending time outside.',
		},
		{
			icon: '/assets/residential/icons/mosquitoes/water-source-activity.png',
			title: 'Water Source Activity',
			description:
				'Mosquitoes hovering around standing water or shady areas in your yard and garden spaces.',
		},
		{
			icon: '/assets/residential/icons/mosquitoes/visible-larvae.png',
			title: 'Visible Larvae',
			description:
				'Wigglers (larvae) spotted in stagnant water like buckets, plant trays, gutters, or bird baths.',
		},
		{
			icon: '/assets/residential/icons/mosquitoes/seasonal-increases.png',
			title: 'Seasonal Increases',
			description:
				'Heightened mosquito activity during warmer months or immediately following rain periods.',
		},
	],
	...
	steps: [
		{
			...
			description:
				'We inspect your yard, drains, and shaded areas to find breeding sites and high-activity zones.',
		},
		{
			title: 'Breeding Site Elimination',
			description:
				'We treat or remove stagnant water sources and apply larvicides where needed to stop mosquito development.',
		},
		{
			title: 'Yard Barrier Spray',
			description:
				'We apply a pet- and kid-safe mosquito repellent around shrubs, fences, patios, and common entry points.',
		},
		{
			title: 'Seasonal & Event Protection',
			description:
				'Ongoing treatments available during peak mosquito season or before outdoor events like weddings or barbecues.',
		},
	],
}
