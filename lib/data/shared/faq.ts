...
// data for ants page
export const antFaqData: FaqProps[] = [

  {
    question: 'How long does ant treatment take?',
    answer: 'Most treatments take 1-2 hours depending on property size and infestation severity. You’ll start seeing results within 24-48 hours.',
  },
  {
    question: 'Is your treatment safe for pets?',
    answer: 'Yes! We use family and pet-friendly products. We’ll provide specific instructions for any precautions during treatment.',
  },
  {
    question: 'Will ants come back after treatment?',
    answer: 'Our treatments are designed for long-term elimination. If ants return within our guarantee period, we’ll come back at no extra charge.',
  },
  {
    question: 'Can I treat ants myself with over-the-counter products?',
    answer: 'DIY products often only kill visible ants, not the colony. Professional treatment targets the source for complete elimination.',
  },
  {
    question: 'How much does ant control cost?',
