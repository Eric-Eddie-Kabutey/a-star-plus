...
// contact data for industries
export const industriesContactData: ContactSectionData = {
  tagline: 'CONTACT US',
...
export const contactData: ContactSectionData = {
  tagline: 'CONTACT US',
  title: 'Request a Free Commercial Consultation',
  description: "We tailor every solution to your business's structure, risk level, and industry.Let's build your pest-free future.",
  contactDetails: [
    {
      icon: "/assets/shared/icons/location.png",
      title: 'Service Area',
