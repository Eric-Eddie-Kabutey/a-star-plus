...
export const heroData2: VersatileHeroData = {
  title: 'Commercial Pest Control Solutions',
  description: 'A Star Plus Pest Control delivers industry-specific pest management programs designed to keep your business protected, compliant, and thriving.',
  actions: (
    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
      <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 text-lg py-6 px-8 rounded-lg w-full sm:w-auto">
        <Link href="#">Schedule Inspection</Link>
      </Button>
      <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white/10 hover:text-white text-lg py-6 px-8 rounded-lg w-full sm:w-auto">
        <a href="tel:2331234567890" className="flex items-center gap-2">
  ...
  imageUrl: 'https://images.unsplash.com/photo-1579752048902-fb3c39367e9f?q=80&w=800', // Placeholder
  imageAlt: 'Technician in a hazmat suit spraying a large warehouse.',
  // No features or corner border for this version
};

// Helper component for the corner border
const CornerBorder = ({ position }: { position: VersatileHeroData['cornerBorderPosition'] }) => {
            ...
            {features && features.length > 0 && (
              ...
              >
                {features.map((feature) => (
                  <div key={feature.title} className="border border-gray-700 rounded-lg p-4 flex-1">
