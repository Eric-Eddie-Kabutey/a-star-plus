...
export function MainHeader() {
	...
	const activeSubMenu = navigationData.find(
		(item) => item.label === activeHover
	)?.submenu
				...
				<div className='container lg:max-w-5xl xl:max-w-7xl mx-auto flex h-20 items-center justify-between px-4'>
					...
					<div className='hidden lg:flex items-center space-x-4'>
						...
						<button
							...
							className='rounded-lg border border-red-600 px-4 py-2 text-sm font-semibold text-red-600 hover:bg-red-50 transition-colors'>
							Create an account
						</button>
						<button
								...
								<nav className='px-2 py-4 mt-8 flex h-full flex-col'>
									...
									<div className='mt-auto flex flex-col space-y-4 pt-6 border-t'>
										...
										<button
											...
											className='rounded-lg border border-red-600 py-2.5 text-lg font-semibold text-red-600 hover:bg-red-50'>
											Create an account
										</button>
										<button
											onClick={() => {
											...
											className='rounded-lg bg-red-600 py-2.5 text-lg font-semibold text-white hover:bg-red-700'>
											Get a Quote
										</button>
									</div>
								</nav>
